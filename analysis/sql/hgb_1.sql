...
FROM pvt
where pvt.hr >24 and pvt.icustay_id in (select icustay_id from `hst-953-2018.team_h.pt_within_inclusion_received_ns_under_24hrs`)
)
SELECT r.subject_id, r.hadm_id, r.icustay_id, min(r.charttime) as first_measure_after_24
