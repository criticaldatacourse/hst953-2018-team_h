...
#Regression with SVM
modelsvm = svm(hgb_difference~.,com_train)
...
#Tune the SVM model
OptModelsvm=tune(svm, hgb_difference~., data=com_train,ranges=list(elsilon=seq(0,1,0.1), cost=1:100))
...
ggplot()+
  ...
  geom_smooth(formula = Error_ab~com_test$hgb_denorm_diff, method = "glm")+
